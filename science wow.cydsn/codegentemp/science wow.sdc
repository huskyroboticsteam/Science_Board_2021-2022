...
# Date: Tue, 09 Aug 2022 04:26:23 GMT
#set_units -time ns
...
create_clock -name {Clock_1ms(FFB)} -period 1000000 -waveform {0 500000} [list [get_pins {ClockBlock/ff_div_11}]]
create_clock -name {Clock_1(FFB)} -period 10000000 -waveform {0 5000000} [list [get_pins {ClockBlock/ff_div_12}] [get_pins {ClockBlock/ff_div_13}]]
...
create_generated_clock -name {Clock_1ms} -source [get_pins {ClockBlock/hfclk}] -edges {1 40001 80001} [list]
create_generated_clock -name {Clock_1} -source [get_pins {ClockBlock/hfclk}] -edges {1 400001 800001} [list [get_pins {ClockBlock/udb_div_0}]]
...
# Project: C:\Users\mewin\OneDrive\Documents\PSoC Creator\Science_Board_2021-2022\science wow.cydsn\science wow.cyprj
# Date: Tue, 09 Aug 2022 04:26:19 GMT
