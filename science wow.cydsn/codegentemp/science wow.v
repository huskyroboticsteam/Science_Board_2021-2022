...
module top ;
    ...
    defparam Timer_LEDs.DeviceFamily = "PSoC4";
    defparam Timer_LEDs.InterruptOnCapture = 0;
    defparam Timer_LEDs.InterruptOnTC = 1;
    defparam Timer_LEDs.Resolution = 24;
    defparam Timer_LEDs.SiliconRevision = "0";
    ...
    Timer_v2_80_7 Timer_1ms (
        .capture(1'b0),
        .capture_out(Net_1035),
        .clock(Net_10),
        .enable(1'b1),
        .interrupt(Net_1037),
        .reset(Net_12),
    ...
    defparam Timer_1ms.DeviceFamily = "PSoC4";
