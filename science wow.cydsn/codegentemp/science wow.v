...
module top ;
	...
	wire [0:0] tmpOE__DBG_LED_net;
	wire [0:0] tmpFB_0__DBG_LED_net;
	wire [0:0] tmpIO_0__DBG_LED_net;
	wire [0:0] tmpINTERRUPT_0__DBG_LED_net;
	electrical [0:0] tmpSIOVREF__DBG_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("a94963b1-1f41-40df-957b-9de684a05822"),
		  ...
		  .input_buffer_sel(2'b00))
		DBG_LED
		 (.oe(tmpOE__DBG_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DBG_LED_net[0:0]}),
		  .io({tmpIO_0__DBG_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__DBG_LED_net),
		  .interrupt({tmpINTERRUPT_0__DBG_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DBG_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ERR_LED_net;
	wire [0:0] tmpFB_0__ERR_LED_net;
	wire [0:0] tmpIO_0__ERR_LED_net;
	wire [0:0] tmpINTERRUPT_0__ERR_LED_net;
	electrical [0:0] tmpSIOVREF__ERR_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		ERR_LED
		 (.oe(tmpOE__ERR_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ERR_LED_net[0:0]}),
		  .io({tmpIO_0__ERR_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__ERR_LED_net),
		  .interrupt({tmpINTERRUPT_0__ERR_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ERR_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Humidity_net;
	wire [0:0] tmpFB_0__Humidity_net;
	wire [0:0] tmpIO_0__Humidity_net;
	wire [0:0] tmpINTERRUPT_0__Humidity_net;
	electrical [0:0] tmpSIOVREF__Humidity_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3f204f59-8282-41b9-8e95-c56ae8f67a05"),
		  ...
		  .input_buffer_sel(2'b00))
		Humidity
		 (.oe(tmpOE__Humidity_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Humidity_net[0:0]}),
		  .analog({Net_752}),
		  .io({tmpIO_0__Humidity_net[0:0]}),
		  .siovref(tmpSIOVREF__Humidity_net),
		  .interrupt({tmpINTERRUPT_0__Humidity_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Humidity_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Debouncer_v1_0 LIM_Debouncer (
        ...
        .pos(Net_490[4:0]),
        .q(Net_556[4:0]));
    defparam LIM_Debouncer.EitherEdgeDetect = 0;
    defparam LIM_Debouncer.NegEdgeDetect = 0;
    defparam LIM_Debouncer.PosEdgeDetect = 0;
    defparam LIM_Debouncer.SignalWidth = 5;

    CyStatusReg_v1_90 Status_Reg_LIM (
        .clock(Net_565),
        .intr(Net_528),
        .status_0(1'b0),
        .status_1(1'b0),
        ...
        .status_6(1'b0),
        .status_7(1'b0),
        .status_bus(Net_556[4:0]));
    defparam Status_Reg_LIM.Bit0Mode = 0;
    defparam Status_Reg_LIM.Bit1Mode = 0;
    defparam Status_Reg_LIM.Bit2Mode = 0;
    defparam Status_Reg_LIM.Bit3Mode = 0;
    defparam Status_Reg_LIM.Bit4Mode = 0;
    defparam Status_Reg_LIM.Bit5Mode = 0;
    defparam Status_Reg_LIM.Bit6Mode = 0;
    defparam Status_Reg_LIM.Bit7Mode = 0;
    defparam Status_Reg_LIM.BusDisplay = 1;
    defparam Status_Reg_LIM.Interrupt = 1;
    defparam Status_Reg_LIM.MaskValue = 31;
    defparam Status_Reg_LIM.NumInputs = 5;
    ...
    assign Net_467[0] = ~Net_459;

	wire [0:0] tmpOE__LIM1_net;
	wire [0:0] tmpIO_0__LIM1_net;
	wire [0:0] tmpINTERRUPT_0__LIM1_net;
	electrical [0:0] tmpSIOVREF__LIM1_net;
	...
	cy_psoc3_pins_v1_10
		...
		LIM1
		 (.oe(tmpOE__LIM1_net),
		  .y({1'b0}),
		  .fb({Net_459}),
		  .io({tmpIO_0__LIM1_net[0:0]}),
		  .siovref(tmpSIOVREF__LIM1_net),
		  .interrupt({tmpINTERRUPT_0__LIM1_net[0:0]}),
		  .annotation({Net_457}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LIM1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__LIM2_net;
	wire [0:0] tmpIO_0__LIM2_net;
	wire [0:0] tmpINTERRUPT_0__LIM2_net;
	electrical [0:0] tmpSIOVREF__LIM2_net;
	...
	cy_psoc3_pins_v1_10
		...
		LIM2
		 (.oe(tmpOE__LIM2_net),
		  .y({1'b0}),
		  .fb({Net_466}),
		  .io({tmpIO_0__LIM2_net[0:0]}),
		  .siovref(tmpSIOVREF__LIM2_net),
		  .interrupt({tmpINTERRUPT_0__LIM2_net[0:0]}),
		  .annotation({Net_465}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LIM2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_467[1] = ~Net_466;
	...
	wire [0:0] tmpOE__LIM3_net;
	wire [0:0] tmpIO_0__LIM3_net;
	wire [0:0] tmpINTERRUPT_0__LIM3_net;
	electrical [0:0] tmpSIOVREF__LIM3_net;
	...
	cy_psoc3_pins_v1_10
		...
		LIM3
		 (.oe(tmpOE__LIM3_net),
		  .y({1'b0}),
		  .fb({Net_470}),
		  .io({tmpIO_0__LIM3_net[0:0]}),
		  .siovref(tmpSIOVREF__LIM3_net),
		  .interrupt({tmpINTERRUPT_0__LIM3_net[0:0]}),
		  .annotation({Net_469}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LIM3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_467[2] = ~Net_470;
	...
	wire [0:0] tmpOE__LIM4_net;
	wire [0:0] tmpIO_0__LIM4_net;
	wire [0:0] tmpINTERRUPT_0__LIM4_net;
	electrical [0:0] tmpSIOVREF__LIM4_net;
	...
	cy_psoc3_pins_v1_10
		...
		LIM4
		 (.oe(tmpOE__LIM4_net),
		  .y({1'b0}),
		  .fb({Net_474}),
		  .io({tmpIO_0__LIM4_net[0:0]}),
		  .siovref(tmpSIOVREF__LIM4_net),
		  .interrupt({tmpINTERRUPT_0__LIM4_net[0:0]}),
		  .annotation({Net_473}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LIM4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_467[3] = ~Net_474;
	...
	wire [0:0] tmpOE__LIM5_net;
	wire [0:0] tmpIO_0__LIM5_net;
	wire [0:0] tmpINTERRUPT_0__LIM5_net;
	electrical [0:0] tmpSIOVREF__LIM5_net;
	...
	cy_psoc3_pins_v1_10
		...
		LIM5
		 (.oe(tmpOE__LIM5_net),
		  .y({1'b0}),
		  .fb({Net_478}),
		  .io({tmpIO_0__LIM5_net[0:0]}),
		  .siovref(tmpSIOVREF__LIM5_net),
		  .interrupt({tmpINTERRUPT_0__LIM5_net[0:0]}),
		  .annotation({Net_477}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LIM5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_467[4] = ~Net_478;
	...
	electrical [0:0] tmpSIOVREF__ENC_1_B_net;

	cy_psoc3_pins_v1_10
		#(.id("e5c61c2e-7d44-484b-9cd1-26457003906c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__ENC_1_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ENC_1_A_net;
	wire [0:0] tmpIO_0__ENC_1_A_net;
	wire [0:0] tmpINTERRUPT_0__ENC_1_A_net;
	electrical [0:0] tmpSIOVREF__ENC_1_A_net;

	cy_psoc3_pins_v1_10
		#(.id("26167aca-9016-492a-8c0a-0279a45d1bef"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__ENC_1_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ENC_2_A_net;
	wire [0:0] tmpIO_0__ENC_2_A_net;
	wire [0:0] tmpINTERRUPT_0__ENC_2_A_net;
	electrical [0:0] tmpSIOVREF__ENC_2_A_net;
	...
	assign tmpOE__ENC_2_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ENC_2_B_net;
	wire [0:0] tmpIO_0__ENC_2_B_net;
	wire [0:0] tmpINTERRUPT_0__ENC_2_B_net;
	electrical [0:0] tmpSIOVREF__ENC_2_B_net;

	cy_psoc3_pins_v1_10
		#(.id("9bb11e2d-a1e5-4e7e-a376-f6c7b6b581f6"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    TCPWM_P4_v2_10_8 Sensor_Packet_Handler (
        .capture(1'b0),
        .cc(Net_766),
        .clock(Net_767),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("f0c36ffe-a996-4f29-b0e6-209b3dadc9e9"),
		  .source_clock_id(""),
		  .divisor(0),
